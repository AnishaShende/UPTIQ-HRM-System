...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!success) {
      toast.error('Invalid credentials. Try admin@hrms.com / admin123 or employee@hrms.com / employee123');
    }
  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br from-[#f8f9fa] via-[#e9d8fd] to-[#c6f6d5] flex items-center justify-center p-6">
      {/* Background Elements */}
              ...
              <div className="mt-6 pt-6 border-t border-gray-100">
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-gray-50 rounded-xl">
                    <p className="text-xs text-gray-600 font-medium mb-1">Administrator Access:</p>
                  ...
                  <div className="p-3 bg-gray-50 rounded-xl">
                    <p className="text-xs text-gray-600 font-medium mb-1">Employee Access:</p>
                    <p className="text-xs text-gray-600">
                      <strong>Email:</strong> employee@hrms.com<br />
