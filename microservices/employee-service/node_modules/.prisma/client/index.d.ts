...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> = {
    meta: {
      modelProps: "department" | "position" | "employee"
  ...
  interface PositionFieldRefs {
    ...
    readonly requirements: FieldRef<"Position", 'String[]'>
    readonly responsibilities: FieldRef<"Position", 'String[]'>
    readonly minSalary: FieldRef<"Position", 'Float'>
    readonly maxSalary: FieldRef<"Position", 'Float'>
    ...
    readonly createdById: FieldRef<"Position", 'String'>
    readonly updatedById: FieldRef<"Position", 'String'>
  }
  ...
  interface EmployeeFieldRefs {
    ...
    readonly personalInfo: FieldRef<"Employee", 'Json'>
    ...
    readonly workLocation: FieldRef<"Employee", 'WorkLocation'>
    readonly salaryGrade: FieldRef<"Employee", 'String'>
    readonly baseSalary: FieldRef<"Employee", 'Float'>
    readonly currency: FieldRef<"Employee", 'String'>
    readonly bankInfo: FieldRef<"Employee", 'Json'>
    readonly createdAt: FieldRef<"Employee", 'DateTime'>
    readonly updatedAt: FieldRef<"Employee", 'DateTime'>
    readonly createdById: FieldRef<"Employee", 'String'>
    readonly updatedById: FieldRef<"Employee", 'String'>
  }
  ...
  export type PositionWhereInput = {
    ...
    requirements?: StringNullableListFilter<"Position">
    responsibilities?: StringNullableListFilter<"Position">
    minSalary?: FloatNullableFilter<"Position"> | number | null
    maxSalary?: FloatNullableFilter<"Position"> | number | null
    status?: EnumStatusFilter<"Position"> | $Enums.Status
    createdAt?: DateTimeFilter<"Position"> | Date | string
    updatedAt?: DateTimeFilter<"Position"> | Date | string
    createdById?: StringNullableFilter<"Position"> | string | null
    updatedById?: StringNullableFilter<"Position"> | string | null
  ...
  export type PositionScalarWhereWithAggregatesInput = {
    ...
    requirements?: StringNullableListFilter<"Position">
    responsibilities?: StringNullableListFilter<"Position">
    minSalary?: FloatNullableWithAggregatesFilter<"Position"> | number | null
    maxSalary?: FloatNullableWithAggregatesFilter<"Position"> | number | null
    ...
    createdById?: StringNullableWithAggregatesFilter<"Position"> | string | null
    updatedById?: StringNullableWithAggregatesFilter<"Position"> | string | null
  }
  ...
  export type EmployeeWhereInput = {
    ...
    personalInfo?: JsonFilter<"Employee">
    ...
    workLocation?: EnumWorkLocationFilter<"Employee"> | $Enums.WorkLocation
    salaryGrade?: StringNullableFilter<"Employee"> | string | null
    baseSalary?: FloatFilter<"Employee"> | number
    currency?: StringFilter<"Employee"> | string
    bankInfo?: JsonNullableFilter<"Employee">
    createdAt?: DateTimeFilter<"Employee"> | Date | string
    updatedAt?: DateTimeFilter<"Employee"> | Date | string
    createdById?: StringNullableFilter<"Employee"> | string | null
    updatedById?: StringNullableFilter<"Employee"> | string | null
    department?: XOR<DepartmentRelationFilter, DepartmentWhereInput>
  ...
  export type EmployeeScalarWhereWithAggregatesInput = {
    ...
    personalInfo?: JsonWithAggregatesFilter<"Employee">
    ...
    workLocation?: EnumWorkLocationWithAggregatesFilter<"Employee"> | $Enums.WorkLocation
    salaryGrade?: StringNullableWithAggregatesFilter<"Employee"> | string | null
    baseSalary?: FloatWithAggregatesFilter<"Employee"> | number
    currency?: StringWithAggregatesFilter<"Employee"> | string
    bankInfo?: JsonNullableWithAggregatesFilter<"Employee">
    createdAt?: DateTimeWithAggregatesFilter<"Employee"> | Date | string
    updatedAt?: DateTimeWithAggregatesFilter<"Employee"> | Date | string
    createdById?: StringNullableWithAggregatesFilter<"Employee"> | string | null
    updatedById?: StringNullableWithAggregatesFilter<"Employee"> | string | null
  }
  ...
  export type PositionCreateInput = {
    ...
    title: string
    description?: string | null
    requirements?: PositionCreaterequirementsInput | string[]
    responsibilities?: PositionCreateresponsibilitiesInput | string[]
    minSalary?: number | null
    maxSalary?: number | null
    status?: $Enums.Status
    createdAt?: Date | string
  ...
  export type PositionUpdateInput = {
    ...
    description?: NullableStringFieldUpdateOperationsInput | string | null
    requirements?: PositionUpdaterequirementsInput | string[]
    responsibilities?: PositionUpdateresponsibilitiesInput | string[]
  ...
  export type PositionCreaterequirementsInput = {
    set: string[]
  }

  export type PositionCreateresponsibilitiesInput = {
    set: string[]
  }
  ...
  export type PositionUpdaterequirementsInput = {
    set?: string[]
    push?: string | string[]
  }

  export type PositionUpdateresponsibilitiesInput = {
    set?: string[]
    push?: string | string[]
  }
